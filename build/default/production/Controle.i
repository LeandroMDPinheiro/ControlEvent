...
void acende(int quant_pessoas){
    ...
    if(quant_pessoas > 0 && quant_pessoas <= 100*0,25)
    {

        PORTBbits.RB7 = 1;
    }
    if(quant_pessoas > 100*0,25 && quant_pessoas <= 100*0,5)
    {

        PORTBbits.RB7 = 1;
        PORTBbits.RB6 = 1;
    }
    if(quant_pessoas > 100*0,5 && quant_pessoas <= 100*0,75)
    {
    ...
    if(quant_pessoas > 100*0,75 && quant_pessoas <= 100)
    {
